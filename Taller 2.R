...
# devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/precios.R?raw=TRUE")
# devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/modeloMV.R?raw=TRUE")
# devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/treynor.R?raw=TRUE")
devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/sortino.R?raw=TRUE")
# devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/performance.R?raw=TRUE")
# devtools::source_url("https://github.com/cazapata25/portfolio/blob/main/performancefm.R?raw=TRUE")
